...
export const Footer = () => {
  return (
    <div className="footer xl:mt-12 bg-slate-400 tracking-widest">
        ...
        <div className="flex w-full justify-between my-4 xl:w-6/12 xl:my-0">
          <div className="footer-col-3 w-6/12 xl:w-full space-y-4">
            ...
            <div className="flex items-center">
              ...
              <a
                href="https://www.instagram.com/ankityd5/"
                className="no-underline text-white text-xs block xl:text-sm"
                target="_blank"
              >
                Instagram
            ...
            <div className="flex items-center">
              ...
              <a
                href="https://www.linkedin.com/in/ankityd5/"
                className="no-underline text-white text-xs block xl:text-sm"
                target="_blank"
              >
                LinkedIn
            ...
            <div className="flex items-center">
              ...
              <a
                href="https://www.facebook.com/profile.php?id=100007769837065"
                className="no-underline text-white text-xs block xl:text-sm"
                target="_blank"
              >
                Facebook
      ...
      Ace the Tech Interview: Your Quiz Prep Platform Designed and Developed By Ankit Yadav.
      </p>
    </div>
  );
};
